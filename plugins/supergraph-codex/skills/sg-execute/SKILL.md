...
| Condition                   | Action                   |
| --------------------------- | ------------------------ |
| Plan file missing          | STOP — run planner first |
| Tests fail after 3 attempts | STOP — mark task failed  |
| Git conflict on resume     | STOP — resolve manually  |
| Environment mismatch       | STOP — re-detect project |