...
**Stuck handling (max 3 attempts):**

- Attempt 1: Re-read error, fix implementation
- Attempt 2: Simplify approach, remove edge cases
- Attempt 3: Log failure to plan, skip task, continue next
- After 3 fails → mark task `> ⚠️ STUCK: [reason]` in plan, escalate to human
...
- Max 3 retries per GREEN step — then escalate
