...
1. Find existing tests:
   ...
   mcp**code-review-graph**find_tests_for(file=[target_file])
...
1. Check impact:
   ...
   mcp**code-review-graph**blast_radius(files=[refactored_file], depth=2)
   mcp**code-review-graph**find_similar(pattern=[current_implementation])
