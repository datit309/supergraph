...
Installer symlink skills vào `.opencode/skills/supergraph`, copy `AGENTS.md` vào project root, và in snippet để thêm vào `opencode.json`:
...
```bash
pip install code-review-graph   # bắt buộc
