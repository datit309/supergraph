...
**Hiện tại: v2.2.1** — Thêm skill `flutter-ui`: dựng Flutter UI từ Figma MCP hoặc ảnh với token-safe code generation, quản lý asset qua `flutter_gen`, và mapping variant/state.
